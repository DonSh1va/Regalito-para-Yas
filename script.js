// Fit the whole page inside the viewport, no scrolling — rescales
// automatically whenever the content's natural size changes (gift
// opening, cards revealing, final screen appearing, window resize).
